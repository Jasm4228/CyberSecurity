"""
    ...
    Number of lines of code in solution:
...
def generate_key(): #AES encryption needs a 16-byte key.
    key = os.urandom(16)
    #key = os.urandom(16).encode();
    return key #USE THIS KEY TO COMMUNICATE INSTEAD OF PRIV/PUB??
...
def main():
    ...
    key = generate_key()
    encrypt_message("testingtesting", key)
